...
func _ready():
	...
	role_object(labor, office_y, -150, -50, 40)
	role_object(labor, office_y, -180, 10, 90)
	role_object(labor, office_y, -400, -250, 90)
	role_object(labor, office_y, -370, -10, 90)
	role_object(soldier, cabin_y, -400, 100, 90)
	role_object(soldier, cabin_y, -10, -10, 60)
...
func _on_come_area_entered(area):
	if Global.level == 3:
		Global.level = 4
	get_tree().change_scene("res://scene/fourth_floor.tscn")
	pass
