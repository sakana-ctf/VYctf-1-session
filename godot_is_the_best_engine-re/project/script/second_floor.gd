...
func _ready():
	...
	role_object(labor, office_y, -158, -158, 60)
	role_object(labor, office_y, -150, 100, 40)
	role_object(labor, office_y, -180, 100, 90)
	role_object(soldier, cabin_y, -90, -10, 80)
	role_object(soldier, cabin_y, -350, -300, 60)
	pass
